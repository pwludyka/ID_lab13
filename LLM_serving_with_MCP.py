...
async def make_llm_request(prompt: str) -> str:
    mcp_servers = {
        ...
        "visualization_server": "http://localhost:8003/mcp",
    }
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "For relative dates such as tomorrow, day after tomorrow, in two weeks, or in two months, you must first call get_current_date. "
                    "Only after receiving the current date, calculate the target date and call get_weather_forecast. "
...
if __name__ == "__main__":
    prompt = """Create a line plot for the following data:
                [[1, 2, 3, 4], [2, 4, 6, 8]]
